...
{
    public class ReadAllCompanyInfoHandler : IRequestHandler<RealAllCompanyInfoQuery, List<CompanyInfoDto>>
    {
        private readonly IMapper _mapper;
        private readonly IRepository<CompanyInfo> _companyInfoRepository = default;

        public ReadAllCompanyInfoHandler(IMapper mapper, IRepository<CompanyInfo> companyInfoRepository)
        {
            _mapper = mapper;
